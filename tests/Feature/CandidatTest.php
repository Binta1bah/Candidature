...
class CandidatTest extends TestCase
{
    ...
    /**
     * Test : L'utilisateur ne peut pas accéder à la liste des candidats sans authentification.
     *
     * Description :
     ...
     *
     * Scénario :
     * 1. Effectuez une requête HTTP GET vers l'endpoint API '/api/candidats'.
    ...
    public function test_email_unique()
    {
        ...
        $response = $this->post('/api/inscription');
    ...
    public function test_nom_string()
    {
        $Candidat =  User::create([
            'nom' => 123,
            'prenom' => 'oumou',
    ...
    public function test_Admin_peut_sauthentifier()
    {
